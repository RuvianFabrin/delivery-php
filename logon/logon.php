...
<div class="easyui-layout">
    <div class="col-sm-4">
        <div class="form-group">
            <div class="aparecer-lento" style="height:45%; width:100%;">
                <img class="img-responsive" src="img/logologin.png">
            </div>
        </div>
        <div class="form-group">
            <form id="frm_logon" name="flogon" method="post" enctype="multipart/form-data" novalidate>
                <div role="form" class="form-horizontal aparecer-lento">
                    <div class="form-border " style="border-color: #FF7F50 !important;">
                        <div class="form-group">
                            <div class="col-sm-1"></div>
                            <div class="col-sm-11">
                                <input type="text" class="form-control" placeholder="Login" required name="login" id="login" autofocus style="width:100%;">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-1"></div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="hidden" name="server" id="server" value="<?php echo ($_SERVER['REQUEST_URI'])?>">
                            <input class="btn btn-default" type="button" id="btn_logon" value="Entrar" style="background-color:#FF7F50;color:white;width:100%; margin-top:10px;"/>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="col-sm-8">
        <div class="aparecer-lento" style=" max-height:750px; max-width:750px;">
        <img class="img-responsive" src="img/noticia_logon.png">
        </div>
    </div>
</div>
...
<script>
<?php require_once 'logon/js/logon.js';?>
</script>